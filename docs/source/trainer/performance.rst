...
Composer provides a :mod:`~composer.profiler` to help users collect and analyze detailed timing information of various events in the training loop 
...
:mod:`~composer.profiler` API Reference.
