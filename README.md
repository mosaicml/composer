...
|----------------|----------|-------------------|---------------------|------------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Ubuntu 24.04   | Base     | 2.6.0             | 12.4.1 (Infiniband) | 3.11             | `mosaicml/pytorch:2.6.0_cu124-python3.11-ubuntu24.04`         |
| Ubuntu 24.04   | Base     | 2.6.0             | 12.4.1 (EFA)        | 3.11             | `mosaicml/pytorch:2.6.0_cu124-python3.11-ubuntu24.04-aws` |
| Ubuntu 24.04   | Base     | 2.6.0             | cpu                 | 3.11             | `mosaicml/pytorch:2.6.0_cpu-python3.11-ubuntu24.04`             |
