...
from composer.callbacks import EarlyStopper, ImageMonitor, MemoryMonitor, SpeedMonitor, ThresholdStopper
...
_callback_marks: Dict[Union[Type[Callback], Type[hp.Hparams]], List[pytest.MarkDecorator],] = {
    ...
    ImageMonitor: [pytest.mark.skipif(not _WANDB_INSTALLED, reason='Wandb is optional')],
}
