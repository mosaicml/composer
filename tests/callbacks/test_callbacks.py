...
def _get_callback_factories():
    callback_factories = [
        ...
        *get_all_subclasses_in_module(composer.loggers, Callback),
    ...
    callback_factories.remove(MemoryMonitor)
    callback_factories.append(pytest.param(MemoryMonitor, marks=pytest.mark.gpu))
