...
def test_eleuther_eval_harness():
    ...
    trainer = Trainer(
        ...
        train_dataloader=DataLoader(RandomCausalLMDataset(size=1, vocab_size=tokenizer.vocab_size,
                                                          sequence_length=2048)),
        eval_dataloader=DataLoader(RandomCausalLMDataset(size=1, vocab_size=tokenizer.vocab_size,
                                                         sequence_length=2048)),
        max_duration='1ep',
        eval_interval='1ep',
