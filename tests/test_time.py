...
def test_timestamp_to_next_batch_epoch():
    ...
    assert timestamp.total_duration == datetime.timedelta(seconds=5)
    assert timestamp.epoch_duration == datetime.timedelta(seconds=5)
    assert timestamp.batch_duration == datetime.timedelta(seconds=5)
    ...
    assert timestamp.total_duration == datetime.timedelta(seconds=5)
    assert timestamp.epoch_duration == datetime.timedelta(seconds=0)
    assert timestamp.batch_duration == datetime.timedelta(seconds=0)
    ...
    assert timestamp.token == 20
    assert timestamp.token_in_epoch == 0
    assert timestamp.total_duration == datetime.timedelta(seconds=15)
    assert timestamp.epoch_duration == datetime.timedelta(seconds=10)
    assert timestamp.batch_duration == datetime.timedelta(seconds=10)
    ...
    assert timestamp.total_duration == datetime.timedelta(seconds=25)
    assert timestamp.epoch_duration == datetime.timedelta(seconds=20)
    assert timestamp.batch_duration == datetime.timedelta(seconds=10)
