...
@world_size(2)
@pytest.mark.gpu
def test_save_sharded_state_dict_to_disk(world_size: int, tmp_path: str):
    ...
    model, _ = _init_model(use_fsdp=True, device='cuda')
...
# @world_size(2, 4)
def test_save_sharded_state_dict_to_disk_cpu(world_size: int, tmp_path: str, use_cpu: bool):
    pass
