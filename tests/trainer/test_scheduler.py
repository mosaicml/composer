...
@pytest.mark.parametrize("scheduler,ssr,test_times,expected_lrs", [
    ...
    pytest.param(functools.partial(linear_scheduler), 1.0, ['100000ba', '200000ba', '400000ba'],
                 [1.0 / 3 + 1.0 / 15, 1.0 / 3 + 2.0 / 15, 1.0 / 3 + 4.0 / 15]),
    ...
    pytest.param(functools.partial(linear_scheduler, start_factor=0.0, total_time='0.25dur'), 1.0,
                 ['100000ba', '200000ba', '400000ba'], [0.4, 0.8, 1.0]),
    pytest.param(functools.partial(linear_scheduler, start_factor=0.0, total_time='0.25dur'), 2.0,
                 ['100000ba', '200000ba', '400000ba'], [0.2, 0.4, 0.8]),
