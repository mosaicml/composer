...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(4, 'adamw', False, 'amp_bf16', False, False, 2, marks=pytest.mark.world_size(4)),
        pytest.param(4, 'adam', False, 'amp_fp16', False, False, 2, marks=pytest.mark.world_size(4)),
    ],
)
