...
@pytest.mark.parametrize('batch,num_samples', [
    [{'a': torch.rand(N, 8), 'b': torch.rand(N, 64)}, N],  # dict
    [[{'a': torch.rand(N, 8)}, {'c': torch.rand(N, 64)}], N],  # list of dict
    [{'a': [1, 2], 'b': [3, 4]}, 2], # dict of lists
