...
from composer.algorithms.selective_backprop.selective_backprop import (apply_selective_backprop,
...
class TestSelectiveBackprop:
    ...
    def test_apply_selective_backprop_true(self, epoch: int, batch: int, interrupt: int) -> None:
    ...
    def test_apply_selective_backprop_false(self, epoch: int, batch: int, interrupt: int) -> None:
    ...
    def test_selective_output_shape_3D(self, X3D: torch.Tensor, y: torch.Tensor, model: torch.nn.Module,
        ...
        X_scaled, y_scaled = apply_selective_backprop(X3D, y, model, loss_fun, keep, scale_factor)
    ...
    def test_selective_output_shape(self, X: torch.Tensor, y: torch.Tensor, model: torch.nn.Module, loss_fun: Callable,
        ...
        X_scaled, y_scaled = apply_selective_backprop(X, y, model, loss_fun, keep, scale_factor)
    ...
    def test_selective_output_shape_scaled(self, Ximage: torch.Tensor, y: torch.Tensor, conv_model: ComposerClassifier,
        ...
        X_scaled, y_scaled = apply_selective_backprop(Ximage, y, conv_model.module, loss_fun, keep, scale_factor)
    ...
    def test_selective_backprop_interp_dim_error(self, X: torch.Tensor, y: torch.Tensor, model: torch.nn.Module,
        ...
        with pytest.raises(ValueError):
            apply_selective_backprop(X, y, model, loss_fun, 1, 0.5)
    ...
    def test_selective_backprop_bad_loss_error(self, X: torch.Tensor, y: torch.Tensor, model: torch.nn.Module,
        ...
        with pytest.raises(TypeError) as execinfo:
            apply_selective_backprop(X, y, model, bad_loss, 1, 1)
