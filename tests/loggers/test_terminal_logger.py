...
from composer.loggers.logger_hparams import TerminalLoggerHparams
...
def test_terminal_logger(composer_trainer_hparams: TrainerHparams, monkeypatch: MonkeyPatch, world_size: int):
    ...
    composer_trainer_hparams.logger_destinations = [TerminalLoggerHparams()]
