...
def _main():
    ...
    nightly_entry = {
        ...
        'CUDA_VERSION': '12.1.0',
        'IMAGE_NAME': 'torch-2-1-0-rc4-cu121',
        'MOFED_VERSION': '5.5-1.0.3.2',
        'PYTHON_VERSION': '3.10',
        'PYTORCH_VERSION': '2.1.0',
        'PYTORCH_NIGHTLY_URL': 'https://download.pytorch.org/whl/test/cu121/',
        'PYTORCH_NIGHTLY_VERSION': 'rc4',
        'TAGS': ['mosaicml/pytorch:2.1.0_cu121-rc4-python3.10-ubuntu20.04'],
    ...
    composer_versions = ['0.16.1']  # Only build images for the latest composer version
