...
def _main():
    ...
    nightly_entry = {
        ...
        'CUDA_VERSION': '12.1.1',
        'IMAGE_NAME': 'torch-nightly-2-4-0-20240512-cu121-python3-11',
        ...
        'PYTORCH_NIGHTLY_VERSION': 'dev20240512+cu121',
        'TAGS': ['mosaicml/pytorch:2.4.0_cu121-nightly20240512-python3.11-ubuntu20.04'],
