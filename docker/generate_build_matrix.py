...
def _main():
    ...
    nightly_entry = {
        ...
        'CUDA_VERSION': '12.1.0',
        'IMAGE_NAME': 'torch-nightly-2-1-0-20230906-cu121',
        'MOFED_VERSION': '5.5-1.0.3.2',
        'PYTHON_VERSION': '3.10',
        'PYTORCH_VERSION': '2.1.0',
        'PYTORCH_NIGHTLY_URL': 'https://download.pytorch.org/whl/nightly/cu121',
        'PYTORCH_NIGHTLY_VERSION': 'dev20230906+cu121',
        'TAGS': ['mosaicml/pytorch:2.1.0_cu121-nightly20230906-python3.10-ubuntu20.04'],
