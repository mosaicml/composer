...
echo "TAG='mosaicml/pytorch:1.11.0_cu113-python3.9-ubuntu20.04' BASE_IMAGE='nvidia/cuda:11.3.1-cudnn8-devel-ubuntu20.04' PYTHON_VERSION='3.9' CUDA_VERSION_TAG='cu113' CUDA_VERSION='11.3.1' LINUX_DISTRO='ubuntu:20.04' PYTORCH_VERSION='1.11.0' TORCHVISION_VERSION='0.12.0' TARGET='pytorch_stage'"
...
echo "TAG='mosaicml/pytorch_vision:1.10.0_cu113-python3.9-ubuntu20.04' TAG='mosaicml/pytorch_vision:latest' BASE_IMAGE='nvidia/cuda:11.3.1-cudnn8-devel-ubuntu20.04' PYTHON_VERSION='3.9' CUDA_VERSION_TAG='cu113' CUDA_VERSION='11.3.1' LINUX_DISTRO='ubuntu:20.04' PYTORCH_VERSION='1.10.0' TORCHVISION_VERSION='0.11.1' TARGET='vision_stage' MMCV_TORCH_VERSION=torch1.10.0"
# MOFED
echo "TAG='mosaicml/pytorch_mofed:1.11.0_cu113-python3.9-ubuntu20.04' BASE_IMAGE='nvidia/cuda:11.3.1-cudnn8-devel-ubuntu20.04' PYTHON_VERSION='3.9' CUDA_VERSION_TAG='cu113' CUDA_VERSION='11.3.1' LINUX_DISTRO='ubuntu:20.04' PYTORCH_VERSION='1.11.0' TORCHVISION_VERSION='0.12.0' TARGET='mofed_stage' MOFED_VERSION='MLNX_OFED_LINUX-5.5-1.0.3.2' MOFED_OS_VERSION='ubuntu20.04'"
