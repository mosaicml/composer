...
|----------------|----------|-------------------|---------------------|------------------|---------------------------------------------------------------------------------------------------|
| Ubuntu 20.04   | Base     | 2.0.1             | 11.7.1 (Infiniband) | 3.10             | `mosaicml/pytorch:2.0.1_cu117-python3.10-ubuntu20.04`                                             |
| Ubuntu 20.04   | Base     | 2.0.1             | 11.7.1 (EFA)        | 3.10             | `mosaicml/pytorch:2.0.1_cu117-python3.10-ubuntu20.04-aws`                                         |
...
| Ubuntu 20.04   | Vision   | 2.0.1             | 11.7.1 (Infiniband) | 3.10             | `mosaicml/pytorch_vision:2.0.1_cu117-python3.10-ubuntu20.04`                                      |
