...
| Ubuntu 20.04   | Vision   | 2.1.0             | 12.1.0 (Infiniband) | 3.10             | `mosaicml/pytorch_vision:latest`, `mosaicml/pytorch_vision:2.1.0_cu121-python3.10-ubuntu20.04`   |
| Ubuntu 20.04   | Vision   | 2.1.0             | cpu                 | 3.10             | `mosaicml/pytorch_vision:latest_cpu`, `mosaicml/pytorch_vision:2.1.0_cpu-python3.10-ubuntu20.04` |
