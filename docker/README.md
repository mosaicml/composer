...
|----------------|----------|-------------------|---------------------|------------------|------------------------------------------------------------------------------------------|
| Ubuntu 22.04   | Base     | 2.7.0             | 12.8.1 (Infiniband) | 3.12             | `mosaicml/pytorch:latest`, `mosaicml/pytorch:2.7.0_cu128-python3.12-ubuntu22.04`         |
| Ubuntu 22.04   | Base     | 2.7.0             | 12.8.1 (EFA)        | 3.12             | `mosaicml/pytorch:latest-aws`, `mosaicml/pytorch:2.7.0_cu128-python3.12-ubuntu22.04-aws` |
