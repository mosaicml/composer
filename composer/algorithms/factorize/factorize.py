...
LOG_NUM_CONV2D_REPLACEMENTS_KEY = 'algorithm_hparams/factorize/num_conv2d_replacements'
LOG_NUM_LINEAR_REPLACEMENTS_KEY = 'algorithm_hparams/factorize/num_linear_replacements'
