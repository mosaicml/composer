...
def image_as_type(image: _InputImgT, typ: Type[_OutputImgT]) -> _OutputImgT:
    ...
    Args:
        image (torch.Tensor | PIL.Image.Image): a single image represented as a :class:`PIL.Image.Image` or
            ...
            and type checking.
        typ (torch.Tensor | PIL.Image.Image): type of the copied image. Must be :class:`PIL.Image.Image`
