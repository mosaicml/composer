...
def _attn(self, query, key, value, attention_mask=None, head_mask=None) -> Tuple[torch.Tensor, torch.Tensor]:
    ...
    GPT2Attention (:func:`transformers.models.gpt2.modeling_gpt2.GPT2Attention._attn`; `GitHub link.
...
def enlarge_mask(module: torch.nn.Module, max_sequence_length: int) -> torch.nn.Module:
    ...
    (:func:`transformers.models.gpt2.modeling_gpt2.GPT2Attention._attn`; `GitHub link.

    <https://github.com/huggingface/tra
