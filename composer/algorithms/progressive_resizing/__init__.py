...
model using the full-sized inputs.See the :doc:`Method Card </method_cards/progressive_resizing_vision>`
for more details.
"""
...
_method_card = 'docs/source/method_cards/progressive_resizing_vision.md'
