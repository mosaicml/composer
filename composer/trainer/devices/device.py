...
class Device(Serializable, ABC):
    ...
    def batch_to_device(self, batch: T_Batch) -> T_Batch:
        ...
        mappings of tensors. Ignores non-tensor items. Preserves sequence and types when possible, otherwise
        converts sequences to lists. Converts mappings to dictionaries.
