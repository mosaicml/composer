...
if version.parse(torch.__version__) < version.parse('1.13.1'):
    ...
    from torch.distributed.fsdp.wrap import (_construct_wrap_fn, _FSDPPolicy, _or_policy, _Policy, _post_order_apply,
                                             _run_mixed_precision_override_policy, _wrap, _wrap_batchnorm_individually,
    ...
    FullyShardedDataParallel._auto_wrap = _custom_auto_wrap_t2p1p0  # type: ignore
