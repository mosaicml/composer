    ...
    def redistribute_local_tensor(
        ...
        *,
        ...
        for transform_info in transform_infos:
            ...
            print(f"bigning debug redistribute {target.is_replicate()=}, {current.is_shard()=}, {target.is_shard()=}, {current.is_replicate()=}")
            ...
            if target.is_replicate():
                ...
                if current.is_partial():
                    ...
                    print(f"bigning debug replace to_replicate_tensor")
