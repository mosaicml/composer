...
class DeepSpeedTrainerHparams(hp.Hparams):
    """Params for the :class:`DeepSpeedTrainer`.

    See the documentation for the :class:`DeepSpeedTrainer`.
    """
    ...
    def initialize_object(self) -> DeepSpeedTrainer:
        from composer.trainer.deepspeed_trainer import DeepSpeedTrainer
        return DeepSpeedTrainer.create_from_hparams(hparams=self)
    ...
    @classmethod
    def load(cls, model: str) -> DeepSpeedTrainerHparams:
        ...
        trainer_hparams = DeepSpeedTrainerHparams.create(model_hparams_file, cli_args=False)
        assert isinstance(trainer_hparams, DeepSpeedTrainerHparams), "trainer hparams should return an instance of self"
