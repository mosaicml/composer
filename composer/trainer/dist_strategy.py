...
def prepare_fsdp_module(
    ...
    def sync_hook(*args):
        ...
        log.info(f"bigning debug  fsdp hook before 2nd all reduce found cuda oom: {found_cuda_oom}")
        print(f"bigning debug  fsdp hook before 2nd all reduce found cuda oom: {found_cuda_oom}")
        dist.all_reduce(all_ranks_finished_tensor, reduce_operation='MIN')
        print(f"bigning debug  fsdp hook after 2nd all reduce")
