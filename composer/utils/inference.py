...
def export_for_inference(
    ...
    Args:
        ...
        onnx_opset_version (int, optional): The opset version ONNX should use for exporting. Defaults to Pytorch's default
            torch.onnx.export opset version, which changes by PyTorch version. (default: ``None``)
