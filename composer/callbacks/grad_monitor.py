...
class GradMonitor(Callback):
    ...
    This callback logs the L2 norm of the gradients of all the parameters in the model,
    and optionally, the L2 norm of the gradients of the parameters by each layer.
