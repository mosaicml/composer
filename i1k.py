...
FLAGS = {}
FLAGS['datadir']='/mnt/gcp/datasets/ImageNet'
FLAGS['batch_size']=128
FLAGS['num_epochs']=18
FLAGS['momentum']=0.9
FLAGS['lr']=0.5
FLAGS['target_accuracy']=None
FLAGS['profiler_port']=9012
FLAGS['opts']=MODEL_OPTS.items()
...
def train_imagenet():
  ...
  if False:#FLAGS.fake_data:
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=8)#FLAGS.num_workers)
  ...
  def train_loop_fn(loader, epoch):
    ...
    for step, (data, target) in enumerate(loader):
      ...
      if lr_scheduler:
        lr_scheduler.step()
      if step % 1000:#FLAGS.log_steps == 0:
        xm.add_step_closure(
